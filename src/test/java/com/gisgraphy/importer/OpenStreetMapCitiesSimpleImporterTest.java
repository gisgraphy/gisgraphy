...
public class OpenStreetMapCitiesSimpleImporterTest {
	...
	public void isUnwantedZipCode(){
		...
		Assert.assertTrue(importer.isUnwantedZipCode("75004 CEDEX"));
		Assert.assertTrue(importer.isUnwantedZipCode("75004 cedex"));
		Assert.assertTrue(importer.isUnwantedZipCode(" "));
		Assert.assertTrue(importer.isUnwantedZipCode(null));
		
		Assert.assertFalse(importer.isUnwantedZipCode("75009"));
