...
public class OutputStyleHelperTest {
	...
	assertEquals("The field list has a wrong size for MEDIUM :" + list, 57,
		list.split(",").length);
	...
	assertEquals("The field list has a wrong size for LONG :" + list, 65,
		list.split(",").length);
