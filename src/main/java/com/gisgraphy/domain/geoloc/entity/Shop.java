...
/**
 * Represents a {@link Shop}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Shop extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Shop} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Shop}
     */
    public Shop(GisFeature gisFeature) {
	super(gisFeature);
    }
