...
/**
 * Represents a {@link Fuel}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Fuel extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Fuel} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Fuel}
     */
    public Fuel(GisFeature gisFeature) {
	super(gisFeature);
    }
