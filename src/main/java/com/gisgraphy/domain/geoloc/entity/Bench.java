...
/**
 * Represents a {@link Bench}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Bench extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Bench} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Bench}
     */
    public Bench(GisFeature gisFeature) {
	super(gisFeature);
    }
