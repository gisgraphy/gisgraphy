...
/**
 * Represents a {@link CityHall}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class CityHall extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link CityHall} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link CityHall}
     */
    public CityHall(GisFeature gisFeature) {
	super(gisFeature);
    }
