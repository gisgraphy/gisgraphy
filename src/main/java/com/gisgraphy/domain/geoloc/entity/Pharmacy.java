...
/**
 * Represents a {@link Pharmacy}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Pharmacy extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Pharmacy} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Pharmacy}
     */
    public Pharmacy(GisFeature gisFeature) {
	super(gisFeature);
    }
