...
/**
 * Represents a {@link Camping}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Camping extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Camping} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Camping}
     */
    public Camping(GisFeature gisFeature) {
	super(gisFeature);
    }
