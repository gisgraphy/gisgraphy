...
/**
 * Represents a {@link Ambulance}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Ambulance extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Ambulance} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link Ambulance}
     */
    public Ambulance(GisFeature gisFeature) {
	super(gisFeature);
    }
