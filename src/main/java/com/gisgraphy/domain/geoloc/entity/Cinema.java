...
/**
 * Represents a {@link Cinema}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Cinema extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Cinema} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Cinema}
     */
    public Cinema(GisFeature gisFeature) {
	super(gisFeature);
    }
