...
/**
 * Represents a {@link Picnic}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Picnic extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Picnic} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Picnic}
     */
    public Picnic(GisFeature gisFeature) {
	super(gisFeature);
    }
