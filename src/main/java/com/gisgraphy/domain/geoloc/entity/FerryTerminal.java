...
/**
 * Represents a {@link FerryTerminal}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class FerryTerminal extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link FerryTerminal} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link FerryTerminal}
     */
    public FerryTerminal(GisFeature gisFeature) {
	super(gisFeature);
    }
