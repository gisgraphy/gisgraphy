...
/**
 * Represents a {@link TourismInfo}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class TourismInfo extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link TourismInfo} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link TourismInfo}
     */
    public TourismInfo(GisFeature gisFeature) {
	super(gisFeature);
    }
