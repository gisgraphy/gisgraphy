...
/**
 * Represents a {@link Fountain}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Fountain extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Fountain} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Fountain}
     */
    public Fountain(GisFeature gisFeature) {
	super(gisFeature);
    }
