...
/**
 * Represents a {@link Sport}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Sport extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Sport} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link Sport}
     */
    public Sport(GisFeature gisFeature) {
	super(gisFeature);
    }
