...
/**
 * Represents a {@link EmergencyPhone}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class EmergencyPhone extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link EmergencyPhone} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link EmergencyPhone}
     */
    public EmergencyPhone(GisFeature gisFeature) {
	super(gisFeature);
    }
