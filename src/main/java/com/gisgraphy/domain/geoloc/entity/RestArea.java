...
/**
 * Represents a {@link RestArea}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class RestArea extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link RestArea} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link RestArea}
     */
    public RestArea(GisFeature gisFeature) {
	super(gisFeature);
    }
