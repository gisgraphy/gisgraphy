...
/**
 * Represents a {@link Rental}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Rental extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Rental} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Rental}
     */
    public Rental(GisFeature gisFeature) {
	super(gisFeature);
    }
