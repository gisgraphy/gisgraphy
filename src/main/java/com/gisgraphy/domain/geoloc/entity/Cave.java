...
/**
 * Represents a {@link Cave}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Cave extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Cave} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Cave}
     */
    public Cave(GisFeature gisFeature) {
	super(gisFeature);
    }
