...
/**
 * Represents a {@link Dentist}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Dentist extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Dentist} with the gisFeature fields<br>
     * 
     * @param gisFeature
     *                The gisFeature from which we want to populate the
     *                {@link Dentist}
     */
    public Dentist(GisFeature gisFeature) {
	super(gisFeature);
    }
