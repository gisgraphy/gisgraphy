...
/**
 * Represents a {@link Craft}.
 * 
 * @author <a href="mailto:david.masclet@gisgraphy.com">David Masclet</a>
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Craft extends GisFeature {
    ...
    /**
     * Constructor that populate the {@link Craft} with the gisFeature
     * fields<br>
     * 
     * @param gisFeature
     ...
     *                {@link Craft}
     */
    public Craft(GisFeature gisFeature) {
	super(gisFeature);
    }
